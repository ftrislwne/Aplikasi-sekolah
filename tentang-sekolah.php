	    			...
	    			<div class="box-body">
	    				...
	    				<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<textarea name="tentang" class="input-control" placeholder="Tentang Sekolah" id="tiny"><?= $d->tentang_sekolah ?></textarea>
							</div>
	    				    ...
	    				    if(isset($_POST['submit'])){
	    				    	...
	    				    	if($_FILES['foto_baru']['name'] != ''){
	    				    	    ...
	    				    	    if(!in_array($formatfile, $allowedtype)){
		    				    		...
		    				    		echo '<div class="alert alert-error">Ukuran File Foto Sekolah Max 1 MB.</div>';
