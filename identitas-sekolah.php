            ...
            <div class="container">
                <div class="box">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Telepon</label>
                            <input type=" email" name="telp" placeholder="Telepon Sekolah" value="<?= $d->telepon ?>" class="input-control" required>
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
                        ...
                        <button type="button" class="btn" onclick="window.location = 'identitas.php'">Kembali</button>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($_FILES['logo_baru']['name'] != ''){
                                ...
                                if(!in_array($formatfile_logo, $allowedtype_logo)){
                                    ...
                                    echo '<div class="alert alert-error"> Format File Logo Tidak di Izinkan.</div>';
                                    return false;
