	    			...
	    			<div class="box-body">
	    				...
	    				<form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
	    					     ...
	    					     <textarea name="sambutan" class="input-control" placeholder="Sambutan Kepala Sekolah" id="tiny"><?= $d->sambutan_kepsek ?></textarea>
                            </div>
	    				    ...
	    				    if(isset($_POST['submit'])){
	    				    	...
	    				    	if($_FILES['foto_baru']['name'] != ''){
	    				    	    ...
	    				    	    if(!in_array($formatfile, $allowedtype)){
		    				    		...
		    				    		echo '<div class="alert alert-error">Ukuran file File Foto Kepala Sekolah Max 1 MB.</div>';
